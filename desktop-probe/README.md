...
Η Factory συσκευάζει επίσης το στατικό `book-v2/` και μόνο τα runtime αρχεία
του κοινού `author/`. Δεν συσκευάζει τον `author/Editor.html`, το
`book-v2/Editor.html` ή τεκμηρίωση συγγραφής.

Το παραγωγικό κουμπί βιβλίου εξακολουθεί να ανοίγει το παλιό `book.html`.
Για απομονωμένη δοκιμή του πρώτου consumer του γενικού Συγγραφέα, εκκίνησε την
ΑΑΤ με:
...
Μετά το ξεκλείδωμα της Πράξης 1, το κουμπί 📖 ανοίγει το `book-v2/`. Αυτό είναι
diagnostic path και δεν ισχυρίζεται ακόμη ισοδυναμία με το δυναμικό Βιβλίο
Παράστασης.
